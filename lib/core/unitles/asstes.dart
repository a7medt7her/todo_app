abstract class AssetsIcon {
  static const String linkIcons = 'assets/icons/';
  static const String passwordIcon = '${linkIcons}Password - Iconly Pro.svg';
  static const String profileIcon = '${linkIcons}Profile - Iconly Pro.svg';
  static const String combinedShape = '${linkIcons}Combined-Shape.svg';
  static const String work = '${linkIcons}Group 1000002771.svg';
